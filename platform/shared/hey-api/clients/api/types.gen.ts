...
export type MistralChatCompletionResponseInput = {
    id: string;
    choices: Array<{
        finish_reason: 'stop' | 'length' | 'tool_calls' | 'content_filter' | 'model_exceeded';
        index: number;
        /**
         * https://docs.mistral.ai/api/#operation/createChatCompletion
         */
...
export type GetChatApiKeysResponses = {
    ...
    200: Array<{
        ...
        organizationId: string;
        name: string;
        provider: 'anthropic' | 'cerebras' | 'gemini' | 'cohere' | 'openai' | 'vllm' | 'ollama' | 'zhipuai' | 'mistral';
...
export type CreateChatConversationData = {
    body: {
        ...
        title?: string | null;
        selectedModel?: string;
        selectedProvider?: 'anthropic' | 'cerebras' | 'gemini' | 'cohere' | 'openai' | 'vllm' | 'ollama' | 'zhipuai' | 'mistral';
        chatApiKeyId?: string | null;
    };
    path?: never;
    query?: never;
...
export type GetOptimizationRulesResponses = {
    ...
    200: Array<{
        ...
        provider: 'openai' | 'gemini' | 'anthropic' | 'cohere' | 'cerebras' | 'vllm' | 'ollama' | 'zhipuai' | 'mistral';
        targetModel: string;
        enabled: boolean;
        createdAt: string;
        updatedAt: string;
