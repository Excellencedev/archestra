 ...
 */
export const minimaxChatCompletionsWithDefaultAgent = <ThrowOnError extends boolean = false>(options: Options<MinimaxChatCompletionsWithDefaultAgentData, ThrowOnError>) => (options.client ?? client).post<MinimaxChatCompletionsWithDefaultAgentResponse, MinimaxChatCompletionsWithDefaultAgentErrors, ThrowOnError>({
 ...
 */
export const minimaxChatCompletionsWithAgent = <ThrowOnError extends boolean = false>(options: Options<MinimaxChatCompletionsWithAgentData, ThrowOnError>) => (options.client ?? client).post<MinimaxChatCompletionsWithAgentResponse, MinimaxChatCompletionsWithAgentErrors, ThrowOnError>({
